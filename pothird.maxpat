...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 116.0, 218.0, 32.0, 22.0 ],
					"text" : "r tri3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 17.5, 218.0, 43.0, 22.0 ],
					"text" : "r rect3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 186.5, 118.0, 51.0, 22.0 ],
					"text" : "r wave3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 103.333333313465118, 261.333334267139435, 40.0, 22.0 ],
					"text" : "tri~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 47.0, 261.333334267139435, 40.0, 22.0 ],
					"text" : "rect~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 448.0, 268.0, 29.5, 22.0 ],
					"text" : "f"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 499.0, 231.0, 42.0, 22.0 ],
					"text" : "edge~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 448.0, 133.0, 37.0, 22.0 ],
					"text" : "swap"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 560.0, 382.0, 56.0, 22.0 ],
					"text" : "thispoly~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 448.0, 600.0, 42.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 448.0, 94.0, 28.0, 22.0 ],
					"saved_object_attributes" : 					{
						"attr_comment" : ""
					}
,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 559.0, 200.0, 61.0, 22.0 ],
					"text" : "adsr~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 559.0, 162.0, 39.0, 22.0 ],
					"text" : "/ 127."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 448.0, 449.0, 29.5, 22.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 448.0, 218.0, 32.0, 22.0 ],
					"text" : "mtof"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 0 ],
					"midpoints" : [ 475.5, 151.0, 457.5, 151.0 ],
					"source" : [ "obj-12", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 0 ],
					"midpoints" : [ 457.5, 155.5, 568.5, 155.5 ],
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 0 ],
					"midpoints" : [ 70.5, 598.0, 408.0, 598.0, 408.0, 438.0, 457.5, 438.0 ],
					"source" : [ "obj-125", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 508.5, 253.0, 457.5, 253.0 ],
					"source" : [ "obj-13", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 457.5, 308.0, 393.0, 308.0, 393.0, 66.0, 112.833333313465118, 66.0 ],
					"order" : 0,
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 457.5, 310.0, 397.0, 310.0, 397.0, 63.0, 56.5, 63.0 ],
					"order" : 1,
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 457.5, 253.5, 468.0, 253.5 ],
					"source" : [ "obj-4", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 568.5, 225.5, 508.5, 225.5 ],
					"order" : 1,
					"source" : [ "obj-9", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 0 ],
					"midpoints" : [ 596.5, 381.5, 569.5, 381.5 ],
					"source" : [ "obj-9", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 1 ],
					"midpoints" : [ 568.5, 369.5, 468.0, 369.5 ],
					"order" : 2,
					"source" : [ "obj-9", 0 ]
				}
